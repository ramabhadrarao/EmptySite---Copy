...
<FORM METHOD=POST ACTION="formeditnew.asp?MODE=1"> 
...
<%'---------------------------Detail Add
Response.Write("<form name=add METHOD=POST action=FORMEDITNEW.ASP?MODE=3>")
  	Response.Write "<tr>"
...
'UPDTSQL="UPDATE SALESORDER SET ORDERVALUE=" & GTOT & " WHERE SALESORDERID=" & ID
