...
<TR>
<TD valign=middle bgcolor=#D4D4D4 bordercolordark=#FFFFFF bordercolor=#808080 bordercolorlight=#808080>&nbsp;&nbsp;<FONT FACE=ARIAL SIZE=2><img src=ofolder.gif border=0 alt='SoftRobot Document Server'><B> SoftRobot Report/Function Designer</B></FONT></TD>
</TR>
</table>
<%MODE=REQUEST("MODE")%>
<%IF MODE="" THEN%>
<FORM NAME=FORMX ACTION=createreport.asp METHOD=POST>
<font face=arial size=2 bgcolor=#E1F2FD><B>Basic Data for creating individual linked documents: </B></font><br>

<TABLE BORDER=1 width=100% bordercolordark=#FFFFFF bordercolorlight=#FFFFFF>
<TR bgcolor=#E1F2FD>
<TD bgcolor=#D5EAFF bordercolordark=#BADFFE bordercolorlight=#808080>
<font face="ARIAL" size="2">Report/Doc Name</font>
</TD>
<TD bgcolor=#D5EAFF bordercolordark=#BADFFE bordercolorlight=#808080>
<font face="ARIAL" size="2">Document Type</font>
</TD>
<TD bgcolor=#D5EAFF bordercolordark=#BADFFE bordercolorlight=#808080>
<font face="ARIAL" size="2">Document Menu</font>
</TD>
<TD bgcolor=#D5EAFF bordercolordark=#BADFFE bordercolorlight=#808080>
<font face="ARIAL" size="2">User Rights</font>
</TD>
</TR>
<TR bgcolor=#E1F2FD>
<TD>
...
<hr>
<font face=arial size=2 bgcolor=#E1F2FD><B>Type1: URL Filename for Manual Reports/Transaction Documents/DTS:</B> </font><br>
<font face=arial size=2>URL Filename :</font><input type="text" name="DADDRESS" size="25" value=filename.asp>
<hr>
<font face=arial size=2 bgcolor=#E1F2FD><B>Type2: SQL for Columnar or Tabular AutoReports or DTS View: </B></font><br>
<textarea rows=3 cols=50 name=SQL>select fieldnames from viewORtablenames</textarea>
<hr>
<font face=arial size=2 bgcolor=#E1F2FD><B>Type3: Data Source and Destination for DTS Services: </B></font><br>
<font face=arial size=2>Source Table/View: <input type=text name=SRCTABLE></font>
<font face=arial size=2>Destination Table/View: <input type=text name=DESTTABLE></font>
<hr>
...
<hr>
<font face="Arial" size="1">
&#169; Copyright 2005 . All rights reserved. IRP & SoftRobot.net
