...
<table width=267 border=0 cellpadding=0 cellspacing=0 ID="Table3">
<tr>
<td background=images/bg1.gif align=center width=249>

<!-- Search_Form -->
<table border=0 cellpadding=0 cellspacing=0 >
      <td><font face=arial size=2 color=black>eCRM - Customer Relation Management</font></td>
...
<form method=post action=usercockpit.asp ID="Form1">
...
<table width=100% >
<td><img src=images/pic06.gif > <br>Sales Manager <br><BR>User: iSALES<br>PWD: iSALES</td>
<td><img src=images/pic07.gif > <br>Marketing Manager <br><BR>User: iMARKETING<br>PWD: iMARKETING</td>
<td><img src=images/pic09.gif > <br>Service Manager <br><BR>User: iSERVICE<br>PWD: iSERVICE</td>
<td><img src=images/pic08.gif > <br>SFA Channel Manager <br><BR>User: iSFA<br>PWD: iSFA</td>
</table>
</td>
</tr>
</table>
